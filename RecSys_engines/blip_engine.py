...
"""
Implement an BLIP-based Multi-modal RecSys engine.
"""
...
class BLIPEngine(Engine):
    def __init__(self):
        self.painting_df = pd.read_csv("data/blip/ng_paintings.csv")
        self.cos_mat = np.load("data/blip/blip_cosine-mat.npy")
