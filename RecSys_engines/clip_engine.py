...
"""
Implement an CLIP-based Multi-modal RecSys engine.
"""
...
class CLIPEngine(Engine):
    def __init__(self):
        self.painting_df = pd.read_csv("data/clip/ng_paintings.csv")
        self.cos_mat = np.load("data/clip/clip_cosine-mat.npy")
